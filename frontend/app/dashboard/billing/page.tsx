...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 motion clips', 'Basic retargeting', '30fps output', 'Community support'] },
  { name: 'Pro', price: '$59/mo', features: ['500 motion clips', 'All skeleton types', '120fps output', 'Batch retargeting', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited clips', 'Custom pipeline', 'Real-time streaming', 'SLA guarantee', 'Dedicated support'] },
];
